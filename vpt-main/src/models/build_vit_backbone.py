...
from .vit_prompt.vit_twokindprompt import PromptedVisionTransformer as PromptedVisionTransformer2stage
from .vit_prompt.vit_twokindprompt_mask import PromptedVisionTransformer as PromptedVisionTransformer2stage_mask
...
from .vit_prompt.vit_moco_twokindprompt import vit_base as prompt_vit_base_2stage
...
def build_mocov3_model(
    ...
    if prompt_cfg is not None:
        model = prompt_vit_base_2stage(prompt_cfg)
    elif adapter_cfg is not None:
...
def build_vit_sup_models(
    ...
    if prompt_cfg is not None:
        model = PromptedVisionTransformer2stage(
